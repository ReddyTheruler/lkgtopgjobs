...
<html lang="en">
  <head>
        ...
        <title>Walkin Interview Jobs in Hyderabad, Telangana - February 2018  </title>
        ...
        <meta name="description" content="software fresher jobs in hyderabad
...
<meta property="og:description" content="software fresher jobs in hyderabad
walkins in hyderabad for freshers
hyderabadwalkins
walkins in hyderabad 2018
btech freshers jobs in hyderabad
...
<script>
  (adsbygoogle = window.adsbygoogle || []).push({
    google_ad_client: "ca-pub-2209768395083661",
  ...
  <body>
      <?php include 'header.php';?>
          ...
          <form action="" align="center" method="POST" enctype="multipart/form-data">
               ...
               <input type="submit" value='Hyderabad' name ="Hyderabad" class="btn btn-primary btn-xs" onclick="location.href = 'index.php';" />
