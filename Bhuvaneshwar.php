...
<html lang="en">
  <head>
        <title>Latest Freshers Walk Interviews Jobs in Bhubaneshwar February 2018</title>
...
{ 
  ...
  $sql = mysqli_query($conn, "SELECT *FROM jobss  WHERE  location='Bhuvaneshwar' ORDER BY id DESC LIMIT 32 ");
