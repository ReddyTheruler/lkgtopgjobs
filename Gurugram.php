...
<html lang="en">
  <head>
        ...
        <title>today Walkins Jobs in Gurgaon - interviews in Gurgaon February 2018</title>
...
{ 
  ...
  $sql = mysqli_query($conn, "SELECT *FROM jobss  WHERE  location='Guragoan' ORDER BY id DESC LIMIT 32 ");
