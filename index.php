...
<html lang="en">
  <head>
        <title>LKGtoPG - Freshers Jobs www.lkgtopg.in (IT, Walkins Jobs) 2018 February</title>
        ...
        <meta name="description" content="itwalkins today interviews jobs ,freshers jobs,pune jobs,bangalore jobs,chennai jobs,noida jobs,mumbai jobs,it jobs, interviews, walk-ins,hyderabad jobs">
...
<script>
 ...
 <!-- <Marquee><Strong>Want to Advertise with us -</strong> <a href="">Call Us- 7997085322</a></marquee> -->
          <form action="" align="center" method="POST" enctype="multipart/form-data">
              <!-- <span id="blinker"><center><strong><span style="color:blue"><a href="walkins.php">Click for Walkins</a></span></strong></center></span>-->  
                <!-- Provides extra visual weight and identifies the primary action in a set of buttons -->
               
 <input type="submit" value='Hyderabad' name ="Hyderabad" class="btn btn-primary btn-xs" onclick="location.href = 'Hyderabad.php';" />
...
{ 
  ...
  $sql = mysqli_query($conn, "SELECT *FROM jobss   ORDER BY id DESC LIMIT 32 ");
